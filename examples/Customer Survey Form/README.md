...
A basic **Survey Form** built with Next.js that submits survey responses directly to a **SmartFormify endpoint**.
...
The browser submits the survey directly to SmartFormify using the standard HTML `POST` method.
