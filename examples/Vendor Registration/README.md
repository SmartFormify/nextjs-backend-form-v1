# Next.js Vendor Registration Form

A basic **Vendor Registration Form** built with Next.js that submits vendor registration details directly to a **SmartFormify endpoint**.
