# Next.js Course Registration Form

A basic **Course Registration Form** built with Next.js that submits registration details directly to a **SmartFormify endpoint**.
