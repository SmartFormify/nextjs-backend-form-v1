# Next.js Franchise Enquiry Form

A basic **Franchise Enquiry Form** built with Next.js that submits franchise enquiry details directly to a **SmartFormify endpoint**.
