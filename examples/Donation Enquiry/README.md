# Next.js Donation Enquiry Form

A basic **Donation Enquiry Form** built with Next.js that submits donation enquiry details directly to a **SmartFormify endpoint**.
